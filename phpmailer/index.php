...
if(isset($_POST['submit'])){
    ...
    $mail->SMTPAuth='true';   
    $mail->SMTPSecure='tls';
    $mail->Username='ayushijaan23@gmail.com';
    $mail->Password='ayushuinoha';
    $mail->setForm($_POST['email'],$_POST['name']);
    $mail->addAddress('ayushijaan23@gmail.com');

    $mail->isHTML(true);
    $mail->Subject='Donation Invoice: '.$_POST['subject'];
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-4 mt-5 bg-light rounded">
        <h1 class="text-center font-weight-bold text-primary">Donate Us</h1>
        <hr class="bg-light">
